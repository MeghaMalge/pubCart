...
class Cart extends React.Component {
    ...
    this.state = {
      CartProducts: [
        ...
        },
        {
          ...
          Qty: 1,
          thumbnail_image:
            "https://www.liltreasures.com.au/assets/full/9EGPR4S8.jpg?20210622113618",
        ...
        },
        {
          ...
          Qty: 1,
          thumbnail_image:
            "https://www.temptationgifts.com/media/catalog/product/cache/623a6c74e30aa11506d045198d97fecc/p/o/portico-joules-jls1904-insulated-water-bottle-01.jpg",
        ...
        },
        {
          ...
          Qty: 1,
          thumbnail_image:
            "https://m.media-amazon.com/images/I/31xabM+dk8L._SY300_SX300_.jpg",
        ...
        },
        {
          ...
          Qty: 1,
          thumbnail_image:
            "https://m.media-amazon.com/images/I/51BLS5zvaiL._SL1129_.jpg",
  ...
  render() {
    let allCartProducts = this.state.CartProducts.map((CartProduct) => (
      <CartItem
    ...
    return (
      <React.Fragment>
        <Container className="mt-5" xl={5}>
          <Row xs={1} sm={1} lg={1} xl={2} className="g-4">
            <Col xl={8}>{allCartProducts}</Col>
            <Col xl={3}>
              <PriceDetails
